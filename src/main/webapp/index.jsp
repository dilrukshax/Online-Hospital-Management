    ...
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron header-jumbotron text-center">
                ...
                <p>
                    <a class="btn btn-primary btn-lg" href="UsersLogin.jsp" role="button">Login</a>
                    <a class="btn btn-primary btn-lg" href="PatientSignup.jsp" role="button">Register</a>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4 text-center">
            <div class="service-item">
                <div class="caption">
                    <h3>Doctor</h3>
                    <p>Doctor can view appointments and prescribe medicines.</p>
                    <p>
                        <a href="UsersLogin.jsp" class="btn btn-primary" role="button">Login</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 text-center">
            <div class="service-item">
                <div class="caption">
                    <h3>Patient</h3>
                    <p>Patient can view appointments and view prescription.</p>
                    <p>
                        <a href="UsersLogin.jsp" class="btn btn-primary" role="button">Login</a>
                    </p>
                </div>
        ...
        <div class="col-md-4 text-center">
            <div class="service-item">
                <div class="caption">
                    <h3>Pharmacist</h3>
                    <p>Pharmacist can add and view medicines.</p>
                    <p>
                        <a href="UsersLogin.jsp" class="btn btn-primary" role="button">Login</a>
                    </p>
                </div>
