...
<div class="limiter" style="display: flex;">
	<div class="container-login100">
		<div class="wrap-login100">
			...
			<form class="login100-form validate-form" action="DeletePrescription" method="post">
                ...
                <div class="wrap-input100 validate-input m-b-18" >
					...
					<input class="input100" type="text" name="diagnostics" value="<%=diagnostics%>" readonly>
					<span class="focus-input100"></span>
				</div>

                <div class="wrap-input100 validate-input m-b-18" >
					<span class="label-input100">Medicine</span>
					<input class="input100" type="text" name="pmedicine" value="<%=pmedicine%>" readonly>
					<span class="focus-input100"></span>
				</div>

                <div class="wrap-input100 validate-input m-b-18" >
					<span class="label-input100">Description</span>
					<input class="input100" type="text" name="pdescription" value="<%=pdescription%>" readonly>
					<span class="focus-input100"></span>
				</div>

                <div class="wrap-input100 validate-input m-b-18" >
					<span class="label-input100">Doctor Name</span>
					<input class="input100" type="text" name="pdoctorname" value="<%=pdoctorname%>" readonly>
					<span class="focus-input100"></span>
				</div>

                <div class="wrap-input100 validate-input m-b-18" >
					<span class="label-input100">DoctorID</span>
					<input class="input100" type="text" name="pdoctorid" value="<%=pdoctorid%>" readonly >
					<span class="focus-input100"></span>
				</div>

                <div class="wrap-input100 validate-input m-b-18" >
					<span class="label-input100">Patient Name</span>
					<input class="input100" type="text" name="ppatientname" value="<%=ppatientname%>" readonly>
					<span class="focus-input100"></span>
				</div>

                <div class="wrap-input100 validate-input m-b-18" >
					<span class="label-input100">Patient ID</span>
					<input class="input100" type="text" name="ppatientid" value="<%=ppatientid%>" readonly>
					<span class="focus-input100"></span>
				</div>
