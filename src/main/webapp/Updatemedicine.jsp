        ...
        <div class="limiter" style="display: flex;">
            <div class="container-login100">
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form" action="UpdateMedicine" method="post">
                        ...
                        <div class="wrap-input100 validate-input m-b-26">
                            ...
                            <input class="input100" type="text" name="medicineName" value="<%=medicineName%>">
                            <span class="focus-input100"></span>
                        </div>

                        <div class="wrap-input100 validate-input m-b-26">
                            <span class="label-input100">Medicine Type</span>
                            <input class="input100" type="text" name="medicineType" value="<%=medicineType%>">
                            <span class="focus-input100"></span>
                        </div>
